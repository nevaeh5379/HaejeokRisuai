export const languageKorean = {
  ...
  characterSnapshots: {
    title: "스냅샷",
    description: "채팅 기록은 건드리지 않고 현재 캐릭터 제작 설정을 저장합니다. 임시 미리보기는 유지하기 전까지 저장소에 기록되지 않습니다.",
    create: "스냅샷 만들기",
    defaultName: "스냅샷",
    namePrompt: "스냅샷 이름",
    created: "스냅샷을 만들었습니다.",
    empty: "아직 만든 스냅샷이 없습니다.",
    previewing: "스냅샷 임시 미리보기",
    previewDescription: "미리보기는 캐릭터를 시험하는 동안 메모리에만 유지되고 저장되지 않습니다. 끝나면 원래 설정으로 돌아가거나 이 상태를 유지할 수 있습니다.",
    revertPreview: "원래 설정으로",
    keepPreview: "이 상태 유지",
    previewKept: "미리보기 상태를 적용했습니다.",
    previewFailed: "저장 대기 중인 캐릭터 변경사항을 기록하지 못해 미리보기를 시작할 수 없습니다.",
    previewBadge: "미리보기 중",
    preview: "미리보기",
    restore: "복원",
    restoreConfirm: "\"{name}\" 스냅샷으로 복원하시겠습니까? 채팅 기록은 유지되고 현재 캐릭터 제작 설정만 교체됩니다.",
    restored: "스냅샷을 복원했습니다.",
    delete: "삭제",
    deleteConfirm: "\"{name}\" 스냅샷을 삭제하시겠습니까?",
  },
  settings: "설정",
  selective: "멀티플 키",
  SecondaryKeys: "두번째 키",
