export const languageKorean = {
    ...
    "storageExplorerDescription": "로컬 파일 시스템 및 S3/RustFS 객체 스토리지를 관리하고 캐릭터별 에셋 용량을 모니터링합니다.",
    ...
    "storageCleanOrphanConfirm": (count: number, size: string) => `어떤 봇에서도 사용하지 않는 미사용 에셋 ${count}개(${size})를 영구 삭제할까요? 이 작업은 되돌릴 수 없습니다.`,
