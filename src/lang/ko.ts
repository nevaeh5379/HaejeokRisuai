export const languageKorean = {
  ...
  setup: {
    ...
    welcomeTitle: "Haejeok RisuAI에 오신 것을 환영해요! ✨",
    welcomeGreeting: "안녕하세요~! 해적 리스AI(Haejeok RisuAI)에 오신 걸 환영해요! ✨ 저는 시작을 도와드릴 아이리스예요.",
    welcomeSubGreeting: "원하시는 시작 방법을 선택해주세요.",
    irisName: "아이리스 (Iris)",
    irisGatewayDefault: "만나서 반가워요! 원하는 방식을 선택해 주세요. 처음이시라면 빠른 설정을 추천해 드려요! ✨",
    irisGatewayDetected: "우와! 이전 데이터(database.bin)를 발견했어요! 바로 복원해드릴까요? ✨",
    irisMigrationDrop: "database.bin 파일을 올려주시면 캐릭터와 대화를 고성능 SQL로 척척 복원해드릴게요!",
    ...
    irisStep3: "API 키와 채팅 번역, 기억 용량 설정을 확인해주세요. 나중에 설정에서 언제든 바꿀 수 있어요!",
    irisStep4: "모든 준비 완료! 이제 Haejeok RisuAI와 함께 시작해볼까요~? 🚀",
    gatewayMigrationTitle: "기존 데이터 가져오기 (마이그레이션)",
    gatewayMigrationDesc: "database.bin 또는 백업 파일에서 기존 캐릭터, 대화, 프리셋을 복원합니다.",
    gatewayQuickSetupTitle: "AI 빠른 추천 설정",
    gatewayQuickSetupDesc: "닉네임과 AI 모델(Claude, OpenAI, Gemini 등)을 몇 단계만에 쉽게 설정합니다.",
    ...
    migrationInProgress: "데이터를 고성능 SQL 저장소로 변환하는 중이에요...",
    migrationSuccessTitle: "마이그레이션 완료! 🎉",
    migrationSuccessDesc: "모든 캐릭터와 대화 기록이 안전하게 이전되었어요! 이제 신나게 즐겨보세요~",
    ...
    allSetMessage: "모든 준비가 끝났어요! 아이리스와 함께 Haejeok RisuAI를 시작해볼까요~? ✨",
