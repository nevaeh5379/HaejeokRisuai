export const languageKorean = {
  ...
  setup: {
    ...
    welcomeGreeting: "안녕하세요~! 리스AI(RisuAI)에 오신 걸 환영해요! ✨ 저는 시작을 도와드릴 아이리스예요.",
    welcomeSubGreeting: "어떻게 시작해볼까요?",
    ...
    gatewaySkipDesc: "기본 설정으로 바로 리스 메인 화면으로 이동합니다. (설정 메뉴에서 언제든 변경 가능)",
    ...
    inputApiKeyTitle: "API 키 입력",
    inputApiKeyPlaceholder: "발급받은 API 키를 여기에 붙여넣어 주세요...",
    nicknameInputPlaceholder: "사용하실 닉네임을 입력해주세요",
    nextStep: "다음",
    prevStep: "이전",
    finishSetup: "리스AI 시작하기 🚀",
    allSetMessage: "모든 준비가 끝났어요! 아이리스와 함께 리스AI를 시작해볼까요~? ✨",
    modelClaudeDesc: "Anthropic Claude - 자연스러운 롤플레잉과 뛰어난 한국어 능력으로 가장 추천해요.",
    modelOpenAIDesc: "OpenAI ChatGPT / GPT-4o - 빠르고 안정적이며 높은 지능을 제공합니다.",
    modelGeminiDesc: "Google Gemini - 방대한 컨텍스트와 빠른 속도, 무료 티어를 지원합니다.",
    modelOpenRouterDesc: "OpenRouter - 다양한 최신 오픈소스 및 상용 모델을 자유롭게 선택할 수 있습니다.",
    modelOllamaDesc: "Ollama / 로컬 - 내 컴퓨터에서 오프라인으로 비공개 구동합니다.",
    modelHordeDesc: "AI Horde - 무료 분산형 커뮤니티 AI 모델입니다.",
  },
  triggerCategories: {
    Special: "특수",
    Control: "제어",
