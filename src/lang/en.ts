export const languageEnglish = {
  ...
  setup: {
    ...
    welcomeGreeting: "Hello there! Welcome to RisuAI! ✨ I am Iris, your guide to get everything ready.",
    ...
    gatewaySkipDesc: "Jump straight into RisuAI with default settings. You can configure everything later in Settings.",
    ...
    selectAiModel: "Choose an AI Model",
    selectAiModelDesc: "Select your preferred AI provider to start chatting.",
    inputApiKeyTitle: "Enter API Key",
    inputApiKeyPlaceholder: "Paste your API key here...",
    nicknameInputPlaceholder: "Enter your nickname",
    nextStep: "Next",
    prevStep: "Back",
    finishSetup: "Launch RisuAI 🚀",
    allSetMessage: "Everything is ready! Let's dive into RisuAI together~ ✨",
    modelClaudeDesc: "Anthropic Claude - Excellent creative roleplaying & multilingual capability.",
    modelOpenAIDesc: "OpenAI ChatGPT / GPT-4o - Fast, versatile, and high intelligence.",
    modelGeminiDesc: "Google Gemini - High speed, vast context window, and generous free tier.",
    modelOpenRouterDesc: "OpenRouter - Access hundreds of open-source and proprietary models.",
    modelOllamaDesc: "Ollama / Local - Run offline AI models privately on your computer.",
    modelHordeDesc: "AI Horde - Community-driven distributed free AI generation.",
  },
  triggerCategories: {
    Special: "Special",
    Control: "Control",
