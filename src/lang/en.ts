export const languageEnglish = {
    ...
    s3Apply: "Apply & Reload",
    s3Applying: "Applying...",
    s3ApplyConfirm: "Apply the S3 storage configuration? Risuai will reload the server settings.",
    s3ApplySuccess: "S3 storage configuration was applied. Reloading...",
