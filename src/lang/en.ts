export const languageEnglish = {
  ...
  characterSnapshots: {
    title: "Snapshots",
    description: "Save the current character configuration without chat history. Temporary previews are not written to storage until you keep them.",
    create: "Create snapshot",
    defaultName: "Snapshot",
    namePrompt: "Snapshot name",
    created: "Snapshot created.",
    empty: "No snapshots yet.",
    previewing: "Temporary snapshot preview",
    previewDescription: "The preview stays in memory while you test the character and is not saved. Return to the previous configuration or keep this state when you are done.",
    revertPreview: "Return to previous",
    keepPreview: "Keep this state",
    previewKept: "Snapshot preview applied.",
    previewFailed: "Could not start the preview because pending character changes could not be saved.",
    previewBadge: "Previewing",
    preview: "Preview",
    restore: "Restore",
    restoreConfirm: "Restore \"{name}\"? Chat history will be kept, but the current character configuration will be replaced.",
    restored: "Snapshot restored.",
    delete: "Delete",
    deleteConfirm: "Delete snapshot \"{name}\"?",
  },
  settings: "Settings",
  selective: "Selective",
  ...
  branchGraphDescription:
    "Branch points stay visible while long linear stretches are collapsed automatically.",
