export const languageChineseTraditional = {
  ...
  errors: {
    ...
    networkFetchPlain:
      "這可能是一次資料抓取（Fetch）錯誤。請嘗試在設定中關閉強制抓取。",
  ...
  help: {
    ...
    oaiapikey:
      "OpenAI 的 API 金鑰，可在 https://platform.openai.com/account/api-keys 取得。",
    mainprompt: "主要提示詞用於決定模型的預設行為。",
    jailbreak: "啟用角色越獄後，將使用越獄提示詞。",
    globalNote:
      "一個對模型行為有強烈影響的備註（也稱為 UJB），適用於所有角色。",
    ...
    loreorder:
      "插入順序越高，對模型的影響力越大。在啟動大量條目時，也更不容易被截斷。",
    ...
    creatorQuotes:
      "說明將顯示在初始訊息之上，用於向使用者提供角色說明。此內容不會進入提示詞中。",
    systemPrompt: "此欄位不為空時，將替換設定中的主要提示詞為此內容。",
    chatNote:
      "這是一個強烈影響模型行為的備註，嵌入於當前對話中，也稱為記憶或 UJB。",
    personality:
      "對角色性格的簡要描述。\n\n**不建議使用此欄位，請填寫在角色描述中。**",
    scenario:
      "對角色情境的簡要描述。\n\n**不建議使用此欄位，請填寫在角色描述中。**",
    ...
    loreSelective:
      "啟用選擇性模式後，需同時匹配關鍵字與次要關鍵字，方可啟用該條目。",
    ...
    inlayImages:
      "啟用後，圖片可嵌入對話中，並且支援此功能的 AI 將能夠看到它們。",
    metrica:
    ...
    chatLoadInitialPages:
      "打開聊天畫面時初始渲染的最近聊天訊息數量。數值越高，可立即顯示更多歷史，但開啟長聊天時可能更吃資源。",
    chatLoadAdditionalPages:
      "每次向上捲動到頂部時額外渲染的舊聊天訊息數量。數值越高，重複載入次數越少，但每次載入可能更重。",
    ...
    dynamicAssetsEditDisplay:
      "啟用後，動態資源將同樣套用於「修改顯示」階段，但這可能會影響效能。",
    nickname:
      "設定後，將在對話中以此暱稱取代角色名稱，並顯示於 {{char}} 和 <char>。",
    useRegexLorebook:
    ...
    openAIFlexProcessing:
      "OpenAI Flex 回應可能比一般回應更慢，但可以用更低的價格（Batch API 價格）取得回應。此開關僅適用於官方 OpenAI Chat Completions 請求。",
    ...
    betaMobileGUI:
      "啟用後，將在小於 800px 的螢幕上使用測試版行動介面，需重新整理頁面。",
    ...
    dynamicMemory:
      "啟用後，助理將在回應時製作記憶筆記。需額外的提示詞才能使用此功能。",
    dynamicResponseTiming: "啟用後，將動態調整回應時機。",
    dynamicRequest:
      "啟用後，將在隨機時機向模型發出請求，而不需等待使用者輸入。",
    settingsCloseButtonSize:
      "調整設定視窗右上角關閉(X)按鈕的大小。預設值為24。",
    ...
    hypaV3RecentMemoryRatio:
      "分配給最近記憶 Token 比例。這部分將會以最新建立的總結自動填滿。",
  ...
  setup: {
    ...
    setProviderLater:
      "還有其他提供商，您可以稍後在設定中設定。如想稍後設定，請選擇此選項。",
    setupOpenAI:
    ...
    openAIDesc:
      "OpenAI GPT 是高品質的 AI 模型，但它付費且存在內容審核，在非英語環境下表現較弱。",
    ...
    chooseChatTypeOption2Desc:
      "推薦非英語使用者。AI 內部以英語處理，但以您的語言進行輸入與輸出。",
    chooseChatTypeOption3: "無語言側重",
    chooseChatTypeOption3Desc:
      "AI 將完全以您的語言進行處理，但可能會降低回應品質。",
    ...
    dropDatabaseBinTitle: "將 database.bin 檔案拖曳至此處",
    dropDatabaseBinDesc: "或點擊選擇 database.bin / .risum / .risup 備份檔案",
    selectFileBtn: "選擇檔案",
    migrationPreviewTitle: "匯入資料預覽",
    migrationCharacters: "角色",
    migrationChats: "對話紀錄",
    migrationPresets: "預設",
    migrationModules: "模組",
    migrationUsername: "使用者名稱",
    ...
    selectAiModel: "選擇 AI 模型提供者",
    selectAiModelDesc: "請選擇用於對話的 AI 模型提供者。",
    ...
    nextStep: "下一步",
    prevStep: "上一步",
    finishSetup: "啟動 Haejeok RisuAI",
    allSetMessage: "所有設定已就緒！與愛麗絲一起開始體驗 Haejeok RisuAI 吧。",
    ...
    modelOpenRouterDesc: "OpenRouter (多模型整合平台)",
    modelCustomDesc: "自訂 / 反向代理 / OpenAI 相容端點",
    modelOllamaDesc: "Ollama / 本機 (離線私密執行)",
    modelHordeDesc: "AI Horde (免費社群分散式模型)",
    modelLaterDesc: "稍後在設定中自行配置",
    badgeBackupFile: "備份檔案",
    badgeDetected: "已偵測到",
    badgeRecommended: "推薦",
    badgeNewRecommended: "推薦",
    badgePopular: "熱門",
    badgeFreeTier: "免費額度",
    badgeFlexible: "多元模型",
    badgeLocalOffline: "本機 / 離線",
    badgeFree: "免費",
    badgeCustom: "自訂設定",
    actionRestore: "匯入",
    actionStart: "開始設定",
    stepIndicator: "步驟",
    chatTranslationMode: "對話翻譯模式",
    chatTransModeEnglish: "英文原版",
    ...
    endpointUrlPlaceholder: "https://api.openai.com/v1 或代理位址",
    modelNameLabel: "模型名稱 (選填)",
    modelNamePlaceholder: "例：claude-3-7-sonnet, deepseek-chat, gpt-4o",
    nicknameTitle: "設定暱稱",
    completeSetupBtn: "完成設定",
  },
  triggerCategories: {
    Special: "特殊",
    Control: "控制",
  ...
  triggerDesc: {
    ...
    v2ImgGen: "圖片生成",
    v2ImgGenDesc:
      "從 {{value}} 生成圖片，負面提示詞為 {{negValue}} => {{outputVar}}",
    v2CheckSimilarity: "檢查相似度",
    v2CheckSimilarityDesc:
      "檢查 {{source}} 與 {{value}} 之間的相似度 => {{outputVar}}",
    v2RunLLM: "執行模型",
    ...
    v2RegexTest: "正規表達式測試",
    v2RegexTestDesc:
      "使用正規表達式 {{regex}} 和旗標 {{flags}} 測試 {{value}} => {{outputVar}}",
    ...
    v2SetCharAtDesc:
      "將 {{source}} 中索引 {{index}} 的字元設定為 {{value}} => {{outputVar}}",
    v2SplitString: "分割字串",
    ...
    v2GetArrayVarDesc:
      "取得陣列變數 {{var}} 索引 {{index}} 的值 => {{outputVar}}",
    ...
    v2GetAlertSelectDesc:
      "取得警示選擇，顯示 {{display}} 選項 {{value}} => {{outputVar}}",
    ...
    v2SetLorebookAlwaysActiveDesc:
      "將索引為 {{index}} 的 Lorebook 設定為常駐 {{value}}",
    v2Calculate: "計算",
  ...
  autoSuggest: "自動建議",
  tokens: "Token",
  generationStatsPosition: "生成狀態浮動視窗",
  generationStatsPositionBottomRight: "右下角 (預設)",
  generationStatsPositionBottomLeft: "左下角",
  generationStatsPositionTopRight: "右上角",
  generationStatsPositionTopLeft: "左上角",
  generationStatsPositionOff: "關閉",
  ...
  folderName: "資料夾名稱",
  folderRemoveConfirm:
    "此資料夾包含 Lorebook。確定要刪除該資料夾及所有內容嗎？",
  emotion: "情緒名稱",
  value: "值",
  reroll: "重新生成",
  chatList: "對話列表",
  ...
  instantRemoveConfirm:
    "只刪除選定的單一訊息嗎？若選擇「否」，該訊息之後的所有訊息也將一併刪除。",
  textColor: "文字顏色",
  classicRisu: "經典 Risu",
  highcontrast: "高對比度",
  ...
  accessibility: "輔助功能",
  sendWithEnter:
    "使用 Enter 鍵發送（未勾選時，發送方式將改為 Shift + Enter。）",
  ...
  openFloatingManager: "在浮動視窗中開啟",
  assetManager: "額外資源管理器",
  filterAll: "全部",
  filterImages: "圖片",
  filterAudio: "音訊",
  filterVideo: "影片",
  ...
  tagCopied: "標籤已複製到剪貼簿",
  batchDelete: "批次刪除",
  batchExclude: "切換提示詞排除",
  selectAll: "全選",
  deselectAll: "取消全選",
  gridSize: "網格大小",
  dropFilesToUpload: "拖放檔案至此處以上傳",
  assetDetails: "資源詳情",
  renameAsset: "重新命名資源",
  duplicateNameWarn: "已存在同名資源",
  noAssetsFound: "未找到資源",
  searchAssets: "搜尋資源...",
  sortBy: "排序",
  sortNameAsc: "名稱 (A-Z)",
  ...
  macroFormats: "巨集格式",
  promptInclusion: "提示詞包含",
  promptIncluded: "包含在提示詞中",
  promptExcluded: "從提示詞中排除",
  deleteAssetConfirm: "確定要刪除選取的資源嗎？",
  delete: "刪除",
  addAsset: "新增資源",
  totalAssetsCount: "{{count}} 個資源",
  viewGrid: "網格檢視",
  viewList: "列表檢視",
  smallSize: "小",
  mediumSize: "中",
  ...
  activeTabChange:
    "由於其他分頁正在運行，當前分頁已暫停。點擊「確定」以切換回此分頁。",
  addCharacter: "新增角色",
  ...
  convertionStep1:
    "請選擇與提示詞相關的檔案（支援 Context、Instruct 及 Sampler JSON）",
  customCSS: "自訂 CSS",
  ...
  staticsDisclaimer:
    "統計資料建基於 2024 年 7 月之後的資料，可能存在部分誤差。",
  subtitles: "字幕",
  ...
  hypaV3Modal: {
    ...
    summarizationConditionLabel:
      "提示：當輸入 Token 超過最大上下文時，HypaV3 將開始進行總結處理。",
  ...
  pluginRisksInuserFriendlyDesc: {
    ...
    globalAccess:
      "外掛試圖存取全域變數，這可能引發預期外的副作用或安全性漏洞。",
    thisOutsideClass:
      "外掛在類別範圍外使用了 'this' 關鍵字，這可能導致意外行為或安全性問題。",
    errorInVerification: "外掛在驗證過程中發生錯誤，代表其功能可能存在問題。",
    storageAccess:
      "外掛試圖存取儲存空間，這可能導致資料外洩或遭未經授權的修改。",
  },
  ...
  fetchLogConsent:
    "外掛 {} 正在請求存取記錄，此操作可能暴露敏感資訊。是否允許？",
  getFullDatabaseConsent:
    "外掛 {} 正在請求存取完整資料庫，此操作可能暴露敏感資訊。是否允許？",
  mainDomAccessConsent:
    "外掛 {} 正在請求存取主文件，此操作可能暴露敏感資訊。是否允許？",
  ...
  sendChatConsent:
    "外掛 {} 正在請求以您的名義發送對話訊息的權限，這將觸發 AI 回應。是否允許？",
  pluginV2Warning:
  ...
  epRequirementsNotMet:
    "未滿足 Easy Panel 的運作條件。點擊下方按鈕可自動調整至最佳設定。",
