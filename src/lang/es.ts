export const languageSpanish = {
  ...
  errors: {
    ...
    networkFetch:
      "Esto ocurre cuando la red es inestable o el servidor está caído.",
    networkFetchWeb:
    ...
    coldStorageRestoreFailed:
      "No se pudieron cargar los datos del almacenamiento frío. Los datos del personaje afectado pueden haberse perdido permanentemente.",
  ...
  help: {
    ...
    forceUrl:
      "Si no está en blanco, la solicitud se enviará a la URL que hayas ingresado.",
    tempature:
    ...
    charDesc:
      "Breve descripción del personaje. Esto afecta las respuestas del personaje.",
    charFirstMessage:
    ...
    experimental:
      "Esta es una característica experimental. Podría ser inestable.",
    oogaboogaURL:
    ...
    replaceGlobalNote:
      "Si no está en blanco, reemplaza la nota global actual con esta.",
    backgroundHTML:
    ...
    openAIFixer:
      "OpenAI Fixer es un complemento que soluciona algunos de los problemas de OpenAI.",
    sayNothing:
    ...
    useExperimental:
      "Si está habilitado, mostrará algunas características experimentales.",
    forceProxyAsOpenAI:
    ...
    chainOfThought:
      "Si está habilitado, agregará el prompt de cadena de pensamientos al prompt.",
    gptVisionQuality:
    ...
    chatLoadInitialPages:
      "Cantidad de mensajes recientes que se renderizan al abrir una pantalla de chat. Los valores más altos muestran más historial de inmediato, pero pueden hacer más pesada la apertura de chats largos.",
    chatLoadAdditionalPages:
      "Cantidad de mensajes antiguos que se renderizan cada vez que te desplazas hasta arriba. Los valores más altos reducen las cargas repetidas, pero pueden hacer más pesada cada carga.",
    emotionPrompt:
    ...
    openAIFlexProcessing:
      "Las respuestas OpenAI Flex pueden ser más lentas que las respuestas normales, pero se obtienen a un precio más bajo (precio de Batch API). Este interruptor solo se aplica a solicitudes oficiales de OpenAI Chat Completions.",
    ...
    v2GetAlertSelect:
      "Las opciones se separan por el carácter | (barra vertical).",
    v2RegexTest:
      "Devuelve 1 si la expresión regular coincide, 0 si no coincide.",
    v2Calculate:
    ...
    dynamicResponseTiming:
      "Cuando está habilitado, ajustará el tiempo de respuesta dinámicamente.",
    dynamicRequest:
  ...
  setup: {
    ...
    chooseCheapOrMemoryOption1Desc:
      "Esto hará que la IA recuerde más, pero será bastante costoso.",
    chooseCheapOrMemoryOption2: "Económico",
    chooseCheapOrMemoryOption2Desc:
      "Esto hará que la IA recuerde menos, pero será más barato.",
    ...
    migrationPresets: "Preajustes",
    migrationModules: "Módulos",
    migrationUsername: "Usuario",
    ...
    nextStep: "Siguiente",
    prevStep: "Atrás",
    finishSetup: "Iniciar Haejeok RisuAI",
    allSetMessage: "¡Todo está listo! Exploremos Haejeok RisuAI juntos.",
    ...
    modelOpenRouterDesc: "OpenRouter (Plataforma multimodelo)",
    modelCustomDesc: "Personalizado / Reverse Proxy / Compatible con OpenAI",
    modelOllamaDesc: "Ollama / Local (Sin conexión y privado)",
    modelHordeDesc: "AI Horde (Modelos comunitarios gratuitos)",
    modelLaterDesc: "Configurar más tarde en Ajustes",
    badgeBackupFile: "Archivo de respaldo",
    badgeDetected: "Detectado",
    badgeRecommended: "Recomendado",
    badgeNewRecommended: "Recomendado",
    badgePopular: "Popular",
    badgeFreeTier: "Nivel gratuito",
    badgeFlexible: "Multimodelo",
    ...
    stepIndicator: "Paso",
    chatTranslationMode: "Modo de traducción de chat",
    chatTransModeEnglish: "Solo inglés",
    ...
    endpointUrlPlaceholder: "https://api.openai.com/v1 o dirección del proxy",
    modelNameLabel: "Nombre del modelo (Opcional)",
    modelNamePlaceholder: "ej. claude-3-7-sonnet, deepseek-chat, gpt-4o",
    nicknameTitle: "Configurar apodo",
    completeSetupBtn: "Completar configuración",
  },
  triggerCategories: {
    Special: "Especial",
    Control: "Control",
  ...
  triggerDesc: {
    ...
    v2SystemPromptDesc:
      "Agregar Prompt del Sistema en {{location}} con {{value}}",
    ...
    v2ImgGenDesc:
      "Generar imagen desde {{value}}, negativo desde {{negValue}} => {{outputVar}}",
    v2CheckSimilarity: "Comprobar Similitud",
    v2CheckSimilarityDesc:
      "Comprobar similitud entre {{source}} y {{value}} => {{outputVar}}",
    ...
    v2RegexTestDesc:
      "Probar {{value}} con regex {{regex}} y flags {{flags}} => {{outputVar}}",
    ...
    v2GetMessageAtIndexDesc:
      "Obtener Mensaje en Índice {{index}} => {{outputVar}}",
    ...
    v2GetLorebookDesc:
      "Obtener Libro de Lore llamado {{target}} => {{outputVar}}",
    v2GetLorebookCount: "Obtener Recuento de Libro de Lore",
    v2GetLorebookCountDesc:
      "Obtener Recuento de Libro de Lore => {{outputVar}}",
    v2GetLorebookEntry: "Obtener Entrada de Libro de Lore",
    v2GetLorebookEntryDesc:
      "Obtener Libro de Lore con índice {{index}} => {{outputVar}}",
    ...
    v2ModifyLorebookDesc:
      "Modificar Libro de Lore llamado {{target}} con {{value}}",
    ...
    v2GetCharAtDesc:
      "Obtener Carácter en Índice {{index}} de {{source}} => {{outputVar}}",
    v2GetCharCount: "Obtener Recuento de Caracteres",
    v2GetCharCountDesc:
      "Obtener Recuento de Caracteres de {{source}} => {{outputVar}}",
    ...
    v2GetCharacterDescDesc:
      "Obtener Descripción del Personaje => {{outputVar}}",
    ...
    v2GetReplaceGlobalNoteDesc:
      "Obtener Nota Global de Reemplazo => {{outputVar}}",
    v2SetReplaceGlobalNote: "Establecer Nota Global de Reemplazo",
    v2SetReplaceGlobalNoteDesc:
      "Establecer Nota Global de Reemplazo a {{value}}",
    ...
    v2DeclareLocalVarDesc:
      "Declarar variable local {{var}} con valor {{value}}",
    ...
    v2GetArrayVarLengthDesc:
      "Obtener Longitud de Variable de Matriz {{var}} => {{outputVar}}",
    ...
    v2GetIndexOfValueInArrayVar:
      "Obtener Índice de Valor en Variable de Matriz",
    ...
    v2JoinArrayVarDesc:
      "Unir Matriz {{var}} con {{delimiter}} => {{outputVar}}",
    ...
    v2GetDictVarDesc:
      "Obtener Valor para Clave {{key}} de Diccionario {{var}} => {{outputVar}}",
    v2SetDictVar: "Establecer Valor de Diccionario",
    v2SetDictVarDesc:
      "Establecer Valor para Clave {{key}} en Diccionario {{var}} a {{value}}",
    ...
    v2HasDictKeyDesc:
      "Comprobar si Diccionario {{var}} tiene Clave {{key}} => {{outputVar}}",
    ...
    v2GetDictKeysDesc:
      "Obtener Todas las Claves de Diccionario {{var}} => {{outputVar}}",
    v2GetDictValues: "Obtener Valores de Diccionario",
    v2GetDictValuesDesc:
      "Obtener Todos los Valores de Diccionario {{var}} => {{outputVar}}",
    ...
    v2GetLastUserMessageDesc:
      "Obtener Último Mensaje de Usuario => {{outputVar}}",
    v2GetLastCharMessage: "Obtener Último Mensaje de Personaje",
    v2GetLastCharMessageDesc:
      "Obtener Último Mensaje de Personaje => {{outputVar}}",
    ...
    v2GetLorebookCountNewDesc:
      "Obtener recuento total de libros de lore => {{outputVar}}",
  ...
  triggerInputLabels: {
    ...
    helpOutputVar:
      "Ingresa el nombre de la variable para almacenar el resultado",
  ...
  playground: {
    ...
    inlayEmptyDesc:
      "Las imágenes, audios y videos adjuntos o generados en chats aparecerán aquí",
  ...
  tokens: "Tokens",
  generationStatsPosition: "Ventana flotante de estadísticas de generación",
  generationStatsPositionBottomRight: "Abajo a la derecha (Predeterminado)",
  generationStatsPositionBottomLeft: "Abajo a la izquierda",
  generationStatsPositionTopRight: "Arriba a la derecha",
  generationStatsPositionTopLeft: "Arriba a la izquierda",
  generationStatsPositionOff: "Desactivado",
  ...
  advancedSettingsWarn:
    "Advertencia: ¡Si no sabes lo que hace la opción, no la cambies!",
  ...
  Chat: "Chat",
  globalLoreInfo:
    "El Libro de Lore del Personaje se aplica a todos los chats del personaje.",
  group: "Grupo",
  groupLoreInfo:
    "El Libro de Lore del Grupo se aplica a todos los chats del grupo.",
  ...
  noPluginSelected:
    "Modelo seleccionado como plugin, pero no se seleccionó ningún plugin.",
  text: "Texto",
  ...
  quickPreset:
    "Puedes cambiar rápidamente el preset con Ctrl + (Índice del Preset)",
  ...
  sayNothing:
    "Ingresar 'no decir nada' cuando no se haya ingresado ninguna cadena",
  ...
  streamingDisplayOptimizationMode:
    "Optimización de visualización en streaming",
  ...
  enterMessageForTranslateToEnglish:
    "Ingresa el Mensaje para Traducir al Inglés",
  recent: "Reciente",
  downloads: "Descargas",
  trending: "Tendencias",
  ...
  changeFolderName:
    "Ingresa el nuevo nombre de la carpeta (deja en blanco para cancelar)",
  cancel: "Cancelar",
  ...
  resetPromptTemplateConfirm:
    "¿Realmente deseas restablecer la plantilla de prompt?",
  ...
  ccv2Desc:
    "Character Card V2 es un formato ampliamente utilizado en programas de chatbot.",
  ccv3Desc:
  ...
  tokenWarning:
    "El cálculo de tokens puede ser inexacto. se recomienda usarlo como referencia.",
  log: "Registro",
  popularityLevelDesc:
  ...
  risuMDesc:
    "El formato RisuM es un formato diseñado específicamente para módulos de Risuai.",
  jsonDesc:
  ...
  hanuraiDesc:
    "HanuraiMemory es un sistema de memoria que utiliza búsqueda de vectores.",
  ...
  doYouWantToBindCurrentPersona:
    "¿Deseas vincular la persona actual a este chat?",
  doYouWantToUnbindCurrentPersona:
    "¿Deseas desvincular la persona de este chat?",
  ...
  previewInfo:
    "Esta vista previa muestra el prompt antes del procesamiento específico del modelo.",
  ...
  otherUserRequesting:
    "Otro usuario ya está solicitando. Inténtalo de nuevo más tarde.",
  ...
  importTranslationCacheSuccess:
    "Se importaron {0} entradas del caché de traducción.",
  ...
  subtitlesWarning1:
    "Debes usar un modelo con entrada de audio/video para usar esta función.",
  subtitlesWarning2:
    "Debes usar un modelo con función de transmisión para usar esta función.",
  reset: "Restablecer",
  ...
  hypaV3Settings: {
    ...
    maxMemoryTokensRatioError:
      "No se puede calcular el ratio máximo de tokens de memoria",
  ...
  hypaV3Modal: {
    ...
    convertLabel:
      "Aún no hay resúmenes, pero puede convertir datos de HypaV2 a V3.",
    ...
    deleteAfterConfirmSecondMessage:
      "Esta acción no se puede deshacer. ¿Está realmente seguro?",
    ...
    nextSummarizationNoMessagesFoundLabel:
      "ADVERTENCIA: No se encontraron mensajes",
    nextSummarizationLoadingError:
      "Error al cargar el siguiente objetivo de resumen: {0}",
    ...
    emptySelectedFirstMessageLabel:
      "ADVERTENCIA: El primer mensaje seleccionado está vacío",
  ...
  triggerV1Warning:
    "El Trigger V1 está obsoleto. podría ser eliminado en el futuro.",
  copy: "Copiar",
  paste: "Pegar",
  depth: "Profundidad",
  ...
  auxModelUnderModelSettings:
    "Mostrar Modelos Auxiliares Separados en Configuración de Modelo",
  ...
  promptInfoEmptyMessage:
    "No hay información de prompt disponible para este mensaje.",
  promptInfoEmptyToggle:
    "No hay interruptores personalizados activos actualmente.",
  ...
  folderRemoveLengthError:
    "Para eliminar una carpeta, no debe contener ninguna entrada.",
  personaNote: "Nota de Persona",
  mcpAccessPrompt:
    '{{tool}} está intentando "{{action}}". ¿deseas permitir esto?',
  ...
  aiGenerationWarning:
    "El contenido será generado por IA y puede contener inexactitudes o sesgos.",
  loadMore: "Cargar más",
  goToChat: "Ir al chat",
  ...
  hamburgerButtonBottom:
    "Mover el botón de menú a la parte inferior de la barra lateral",
  ...
  nanoGPTCancelsAtPeriodEnd: (date: string) =>
    `Se cancela al final del período (${date})`,
  nanoGPTWeeklyTokens: (pct: string) =>
    `Tokens de entrada incluidos semanales — ${pct} usados`,
  nanoGPTDailyTokens: (pct: string) =>
    `Tokens de entrada incluidos diarios — ${pct} usados`,
  nanoGPTDailyImages: (pct: string) =>
    `Imágenes incluidas diarias — ${pct} usadas`,
  ...
  nanoGPTCouldNotLoadAccountInfo:
  ...
  modelGridCouldNotLoad:
    "No se pudo cargar la lista de modelos. Verifique su clave API.",
  ...
  noMatchingSessions: "No se encontraron sesiones",
