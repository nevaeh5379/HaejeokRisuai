export const languageVietnamese = {
  ...
  errors: {
    toomuchtoken:
      "Lỗi: Mã thông báo bắt buộc tối thiểu lớn hơn Kích thước ngữ cảnh tối đa.",
    ...
    coldStorageRestoreFailed:
      "Không thể tải dữ liệu bộ nhớ lạnh. Dữ liệu của nhân vật bị ảnh hưởng có thể đã bị mất vĩnh viễn.",
  ...
  help: {
    ...
    jailbreak:
      "Tùy chọn lời nhắc jailbreak kích hoạt khi nút chuyển đổi jailbreak được bật.",
    globalNote:
    ...
    charDesc:
      "Mô tả ngắn gọn về nhân vật. điều này ảnh hưởng đến phản ứng của nhân vật.",
    charFirstMessage:
    ...
    systemPrompt:
      "Lời nhắc thay thế lời nhắc chính trong cài đặt nếu nó không trống.",
    chatNote:
    ...
    openAIFixer:
      "OpenAI Fixer là một plugin khắc phục một số vấn đề của OpenAI.",
    sayNothing:
      "Nếu được bật, nó sẽ nhập 'say nothing' khi không có chuỗi nào được nhập.",
    showUnrecommended:
    ...
    chainOfThought:
      "Nếu được bật, nó sẽ thêm lời nhắc chuỗi suy nghĩ vào lời nhắc.",
    gptVisionQuality:
    ...
    requestretrys:
      "Tùy chọn này được sử dụng để đặt số lần thử lại yêu cầu khi yêu cầu thất bại.",
    chatLoadInitialPages:
      "Số tin nhắn trò chuyện gần đây được hiển thị khi mở màn hình trò chuyện. Giá trị cao hơn hiển thị thêm lịch sử ngay lập tức nhưng có thể làm chat dài mở nặng hơn.",
    chatLoadAdditionalPages:
      "Số tin nhắn cũ được hiển thị thêm mỗi khi bạn cuộn lên đầu. Giá trị cao hơn giảm số lần tải lặp lại nhưng mỗi lần tải có thể nặng hơn.",
    emotionPrompt:
    ...
    removePunctuationHypa:
      "Nếu được bật, nó sẽ xóa dấu câu trước khi thực thi HypaMemory.",
    additionalParams:
    ...
    openAIFlexProcessing:
      "Phản hồi OpenAI Flex có thể chậm hơn phản hồi thông thường, nhưng có giá rẻ hơn (giá Batch API). Công tắc này chỉ áp dụng cho yêu cầu OpenAI Chat Completions chính thức.",
    ...
    unrecommended:
      "Đây là cài đặt không được khuyến nghị. Không nên sử dụng cài đặt này.",
    jsonSchema:
    ...
    autoAdjustSchema:
      "Khi được bật, nó sẽ tự động điều chỉnh JSON schema cho Đầu ra Động.",
    dynamicMessages:
    ...
    dynamicResponseTiming:
      "Khi được bật, nó sẽ điều chỉnh thời gian phản hồi một cách linh hoạt.",
    dynamicRequest:
    ...
    dynamicOutputPrompt:
      "Khi được bật, thông tin lược đồ sẽ được bao gồm trong yêu cầu.",
    realmDirectOpen:
    ...
    hideAllImagesDesc:
      "Ẩn biểu tượng bot, tài nguyên hình ảnh bot và ảnh bìa RisuRealm.",
    embedding:
  ...
  setup: {
    ...
    setupSelfHelp:
      "Tự thiết lập trong cài đặt, sau khi màn hình Chào mừng kết thúc.",
    ...
    setupLaterMessage:
      "Chào mừng {username}! bạn muốn tôi hướng dẫn cài đặt hay tự làm?",
    ...
    chooseCheapOrMemoryOption1Desc:
      "Điều này sẽ khiến AI ghi nhớ nhiều hơn, nhưng sẽ khá đắt.",
    chooseCheapOrMemoryOption2: "Giá rẻ",
    chooseCheapOrMemoryOption2Desc:
      "Điều này sẽ khiến AI ghi nhớ ít hơn, nhưng sẽ rẻ hơn.",
    ...
    migrationChats: "Lịch sử trò chuyện",
    migrationPresets: "Cấu hình mẫu",
    migrationModules: "Mô-đun",
    migrationUsername: "Tên người dùng",
    ...
    modelOpenRouterDesc: "OpenRouter (Cổng kết nối đa mô hình)",
    modelCustomDesc: "Tùy chỉnh / Reverse Proxy / Tương thích OpenAI",
    modelOllamaDesc: "Ollama / Cục bộ (Ngoại tuyến & Riêng tư)",
    modelHordeDesc: "AI Horde (Mô hình phân tán cộng đồng miễn phí)",
    modelLaterDesc: "Cấu hình sau trong Cài đặt",
    badgeBackupFile: "Tệp sao lưu",
    badgeDetected: "Đã phát hiện",
    badgeRecommended: "Khuyên dùng",
    badgeNewRecommended: "Khuyên dùng",
    badgePopular: "Phổ biến",
    badgeFreeTier: "Gói miễn phí",
    badgeFlexible: "Đa mô hình",
    badgeLocalOffline: "Cục bộ / Ngoại tuyến",
    badgeFree: "Miễn phí",
    badgeCustom: "Tùy chỉnh",
    actionRestore: "Khôi phục",
    actionStart: "Bắt đầu",
    stepIndicator: "Bước",
    chatTranslationMode: "Chế độ dịch trò chuyện",
    chatTransModeEnglish: "Tiếng Anh gốc",
    ...
    endpointUrlPlaceholder: "https://api.openai.com/v1 hoặc địa chỉ proxy",
    modelNameLabel: "Tên mô hình (Tùy chọn)",
    modelNamePlaceholder: "ví dụ: claude-3-7-sonnet, deepseek-chat, gpt-4o",
    nicknameTitle: "Cài đặt biệt danh",
    completeSetupBtn: "Hoàn tất cài đặt",
  },
  triggerCategories: {
    Special: "Đặc biệt",
    Control: "Điều khiển",
  ...
  triggerDesc: {
    ...
    v2ImgGenDesc:
      "Tạo hình ảnh từ {{value}}, phủ định từ {{negValue}} => {{outputVar}}",
    v2CheckSimilarity: "Kiểm tra độ tương đồng",
    v2CheckSimilarityDesc:
      "Kiểm tra độ tương đồng giữa {{source}} và {{value}} => {{outputVar}}",
    ...
    v2RegexTestDesc:
      "Kiểm tra {{value}} bằng regex {{regex}} và cờ {{flags}} => {{outputVar}}",
    ...
    v2GetMessageAtIndexDesc:
      "Lấy tin nhắn tại chỉ số {{index}} => {{outputVar}}",
    ...
    v2GetLorebookEntryDesc:
      "Lấy Sách truyền thuyết với chỉ số {{index}} => {{outputVar}}",
    ...
    v2ModifyLorebookDesc:
      "Sửa đổi Sách truyền thuyết tên {{target}} với {{value}}",
    ...
    v2GetCharAtDesc:
      "Lấy ký tự tại chỉ số {{index}} từ {{source}} => {{outputVar}}",
    ...
    v2GetArrayVarLengthDesc:
      "Lấy độ dài của biến mảng {{var}} => {{outputVar}}",
    v2GetArrayVar: "Lấy biến mảng",
    v2GetArrayVarDesc:
      "Lấy giá trị tại chỉ số {{index}} từ biến mảng {{var}} => {{outputVar}}",
    v2SetArrayVar: "Đặt biến mảng",
    v2SetArrayVarDesc:
      "Đặt giá trị tại chỉ số {{index}} trong biến mảng {{var}} thành {{value}}",
    ...
    v2PopArrayVarDesc:
      "Xóa giá trị cuối cùng từ biến mảng {{var}} => {{outputVar}}",
    v2ShiftArrayVar: "Xóa giá trị đầu tiên từ biến mảng và lấy",
    v2ShiftArrayVarDesc:
      "Xóa giá trị đầu tiên từ biến mảng {{var}} => {{outputVar}}",
    v2UnshiftArrayVar: "Thêm vào biến mảng làm giá trị đầu tiên",
    v2UnshiftArrayVarDesc:
      "Thêm {{value}} làm giá trị đầu tiên của biến mảng {{var}}",
    v2SpliceArrayVar: "Thêm vào biến mảng tại chỉ số",
    v2SpliceArrayVarDesc:
      "Thêm {{value}} làm giá trị {{start}} của biến mảng {{var}}",
    v2SliceArrayVar: "Cắt biến mảng",
    v2SliceArrayVarDesc:
      "Cắt biến mảng {{var}} từ {{start}} đến {{end}} => {{outputVar}}",
    ...
    v2RemoveIndexFromArrayVarDesc:
      "Xóa giá trị tại chỉ số {{index}} khỏi biến mảng {{var}}",
    ...
    v2GetDictVarDesc:
      "Lấy giá trị cho khóa {{key}} từ từ điển {{var}} => {{outputVar}}",
    v2SetDictVar: "Đặt giá trị từ điển",
    v2SetDictVarDesc:
      "Đặt giá trị cho khóa {{key}} trong từ điển {{var}} thành {{value}}",
    v2DeleteDictKey: "Xóa khóa từ điển",
    v2DeleteDictKeyDesc: "Xóa khóa {{key}} khỏi từ điển {{var}}",
    v2HasDictKey: "Có khóa từ điển",
    v2HasDictKeyDesc:
      "Kiểm tra nếu từ điển {{var}} có khóa {{key}} => {{outputVar}}",
    ...
    v2GetDictKeysDesc:
      "Lấy tất cả các khóa từ từ điển {{var}} => {{outputVar}}",
    v2GetDictValues: "Lấy các giá trị từ điển",
    v2GetDictValuesDesc:
      "Lấy tất cả các giá trị từ từ điển {{var}} => {{outputVar}}",
    ...
    v2GetLastUserMessageDesc:
      "Lấy tin nhắn người dùng cuối cùng => {{outputVar}}",
    v2GetLastCharMessage: "Lấy tin nhắn nhân vật cuối cùng",
    v2GetLastCharMessageDesc:
      "Lấy tin nhắn nhân vật cuối cùng => {{outputVar}}",
    ...
    v2GetAlertSelectDesc:
      "Lấy lựa chọn cảnh báo {{display}} tùy chọn {{value}} => {{outputVar}}",
    ...
    v2GetRequestStateDesc:
      "Lấy nội dung yêu cầu tại {{index}} => {{outputVar}}",
    ...
    v2GetRequestStateRoleDesc:
      "Lấy vai trò dữ liệu yêu cầu tại {{index}} => {{outputVar}}",
    v2SetRequestStateRole: "Đặt vai trò dữ liệu yêu cầu",
    v2SetRequestStateRoleDesc:
      "Đặt vai trò dữ liệu yêu cầu tại {{index}} thành {{value}}",
    ...
    v2GetAllLorebooksDesc:
      "Lấy tất cả lời nhắc Sách truyền thuyết dưới dạng mảng => {{outputVar}}",
    ...
    v2GetLorebookCountNewDesc:
      "Lấy tổng số Sách truyền thuyết => {{outputVar}}",
  ...
  playground: {
    ...
    inlayDeleteMultipleConfirm:
      "Bạn có chắc muốn xóa ${count} tài sản được chọn không?",
  ...
  tokens: "Mã thông báo",
  generationStatsPosition: "Cửa sổ nổi trạng thái tạo phản hồi",
  generationStatsPositionBottomRight: "Dưới cùng bên phải (Mặc định)",
  generationStatsPositionBottomLeft: "Dưới cùng bên trái",
  generationStatsPositionTopRight: "Trên cùng bên phải",
  generationStatsPositionTopLeft: "Trên cùng bên trái",
  generationStatsPositionOff: "Tắt",
  ...
  advancedSettingsWarn:
    "Cảnh báo: Nếu bạn không biết tùy chọn này làm gì, đừng thay đổi nó!",
  ...
  Chat: "Trò chuyện",
  globalLoreInfo:
    "Lorebook nhân vật áp dụng cho tất cả các cuộc trò chuyện trong nhân vật.",
  group: "Nhóm",
  groupLoreInfo:
    "Group Lorebook áp dụng cho tất cả các cuộc trò chuyện trong nhóm.",
  ...
  disabled: "Tàn tật",
  noPluginSelected:
    "Mô hình được chọn làm plugin nhưng không có plugin nào được chọn.",
  text: "Chữ",
  ...
  backupLoadConfirm2:
    "Bạn có thực sự muốn tải bản sao lưu không? Tất cả dữ liệu sẽ bị mất!",
  pasteAuthCode:
    "Vui lòng sao chép mã xác thực từ cửa sổ bật lên và dán vào đây:",
  others: "Người khác",
  ...
  quickPreset:
    "Bạn có thể nhanh chóng thay đổi cài đặt trước bằng Ctrl + (Chỉ mục cài sẵn)",
  ...
  sendWithEnter:
    "Gửi bằng phím Enter(Shift + Enter chuyển sang gửi tin nhắn khi không kiểm tra.)",
  ...
  invaildTriggerEffect:
    "Hiệu ứng này không hoạt động đối với loại kích hoạt này.",
  ...
  ccv2Desc:
    "Character Card V2 là định dạng được sử dụng rộng rãi trong các chương trình chatbot.",
  ccv3Desc:
  ...
  passwordDesc:
    "Bạn có thể đặt mật khẩu để bảo vệ thẻ của mình khỏi truy cập trái phép.",
  ...
  tokenWarning:
    "Tính toán token có thể không chính xác. Nên sử dụng nó để tham khảo.",
  log: "Nhật ký",
  popularityLevelDesc:
  ...
  risuMDesc:
    "Định dạng RisuM là định dạng được thiết kế dành riêng cho các mô-đun Risuai.",
  jsonDesc:
    "Định dạng JSON là định dạng dễ đọc và viết cho cả con người và máy móc.",
  nickname: "Biệt danh",
  ...
  supaDesc:
    "SupaMemory là hệ thống bộ nhớ dài hạn sử dụng dữ liệu tóm tắt cho AI.",
  ...
  format: "Định dạng",
  v2Warning:
    "Cảnh báo: Thẻ V2 không còn được hỗ trợ. Nó có thể không chứa tất cả dữ liệu.",
  ...
  previewInfo:
    "Bản xem trước này hiển thị lời nhắc trước khi xử lý theo mô hình cụ thể.",
  ...
  reloadSession:
    "Đã tìm thấy phiên bản dữ liệu lưu mới hơn. Đang tải lại phiên...",
  ...
  loading: "Đang tải",
  autoTranslateCachedOnly:
    "Chỉ tự động dịch các tin nhắn đã lưu vào bộ nhớ đệm",
  notification: "Thông báo",
  permissionDenied:
    "Quyền bị từ chối bởi trình duyệt hoặc hệ điều hành của bạn",
  ...
  subtitles: "Phụ đề",
  subtitlesWarning1:
    "Bạn phải sử dụng mô hình có đầu vào âm thanh/video để sử dụng tính năng này.",
  subtitlesWarning2:
  ...
  hypaV3Modal: {
    ...
    convertLabel:
      "Chưa có tóm tắt nào, nhưng bạn có thể chuyển đổi dữ liệu HypaV2 sang V3.",
    ...
    nextSummarizationLoadingError:
      "Lỗi khi tải mục tiêu tóm tắt tiếp theo: {0}",
    ...
    emptySelectedFirstMessageLabel:
      "CẢNH BÁO: Tin nhắn đầu tiên được chọn trống",
  ...
  auxModelUnderModelSettings:
    "Hiển thị tách biệt mô hình phụ trong cài đặt mô hình",
  ...
  doNotChangeSeperateModels:
    "Không thay đổi mô hình tách biệt khi thay đổi cài đặt trước",
  tools: "Công cụ",
  action: "Hành động",
  hotkey: "Phím nóng",
  hotkeyDesc: {
  ...
  doNotChangeFallbackModels:
    "Không thay đổi mô hình dự phòng khi thay đổi cài đặt trước",
  ...
  mcpAccessPrompt:
    '{{tool}} đang cố gắng "{{action}}". Bạn có muốn cho phép điều này không?',
  ...
  bookmarkAskNameOrDefault:
    "Nhập tên dấu trang. Nếu không nhập, nó sẽ được gán tự động.",
  bookmarkAskNameOrCancel:
    "Nhập tên dấu trang. Nếu không nhập, việc đổi tên sẽ bị hủy.",
  ...
  nanoGPTWeeklyTokens: (pct: string) =>
    `Token đầu vào hàng tuần — đã dùng ${pct}`,
  nanoGPTDailyTokens: (pct: string) =>
    `Token đầu vào hàng ngày — đã dùng ${pct}`,
  ...
  modelGridCouldNotLoad:
    "Không thể tải danh sách mô hình. Kiểm tra khóa API của bạn.",
  ...
  recentSessions: "Phiên trò chuyện gần đây",
  noRecentSessions: "Không có phiên gần đây",
  searchSessions: "Tìm kiếm phiên trò chuyện...",
  noMatchingSessions: "Không tìm thấy phiên trò chuyện phù hợp",
