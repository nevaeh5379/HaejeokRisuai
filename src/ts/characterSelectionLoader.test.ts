...
import { loadCharacterSelectionData, type SelectionCharacter } from './characterSelectionLoader'
...
describe('loadCharacterSelectionData', () => {
    it('loads known shallow character and chat data in parallel', async () => {
        ...
        const ensureCharacterDetails = vi.fn(() => new Promise<void>((resolve) => {
        ...
        const preLoadChat = vi.fn(() => new Promise<void>((resolve) => {
