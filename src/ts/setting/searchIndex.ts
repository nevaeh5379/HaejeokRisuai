...
const sources: SearchSource[] = [
  {
    items: displayThemeSettingsItems,
    menuIndex: 3,
    subTab: 0,
    pageLabel: () => language.display,
    tabLabel: () => language.theme,
  },
  {
    items: displaySizeSettingsItems,
    menuIndex: 3,
    subTab: 1,
    pageLabel: () => language.display,
    tabLabel: () => language.sizeAndSpeed,
  },
  {
    items: displayOtherSettingsItems,
    menuIndex: 3,
    subTab: 2,
    pageLabel: () => language.display,
    tabLabel: () => language.others,
  },
  {
    items: accessibilitySettingsItems,
    menuIndex: 11,
    pageLabel: () => language.accessibility,
  },
  {
    items: advancedSettingsItems,
    menuIndex: 6,
    pageLabel: () => language.advancedSettings,
  },
  {
    items: languageSettingsItems,
    menuIndex: 10,
    pageLabel: () => language.language,
  },
  {
    items: allBasicParameterItems,
    menuIndex: 1,
    subTab: 1,
    pageLabel: () => language.chatBot,
    tabLabel: () => language.parameters,
  },
];
...
const manualEntries: ManualEntry[] = [
  ...
  },
  {
    ...
    keywords: ["chatbot", "model", "ai", "챗봇", "모델"],
    target: { kind: "menu", menuIndex: 1 },
  },
  {
    id: "chatbot.model",
  ...
  },
  {
    ...
    target: { kind: "menu", menuIndex: 1, subTab: 1 },
    location: () => language.chatBot,
  },
  {
    id: "chatbot.prompt",
    ...
    target: { kind: "menu", menuIndex: 1, subTab: 2 },
    location: () => language.chatBot,
  },
  {
    id: "chatbot.others",
    label: () => language.others,
    keywords: ["bias", "additional params", "custom flags", "tools", "기타"],
    target: { kind: "menu", menuIndex: 1, subTab: 3 },
    location: () => language.chatBot,
  },
  {
    id: "page.otherBots",
    label: () => language.otherBots,
    keywords: [
      "other bots",
      "auxiliary",
      "memory",
    ...
    target: { kind: "menu", menuIndex: 2 },
  },
  {
    id: "other.memory",
    label: () => language.longTermMemory,
    keywords: ["memory", "hypa", "supa", "embedding", "메모리", "장기기억"],
    target: { kind: "menu", menuIndex: 2, subTab: 0 },
    location: () => language.otherBots,
  },
  {
    id: "other.tts",
    label: () => "TTS",
    keywords: ["tts", "voice", "speech", "elevenlabs", "음성", "보이스"],
    target: { kind: "menu", menuIndex: 2, subTab: 1 },
    location: () => language.otherBots,
  },
  {
    id: "other.emotion",
    label: () => language.emotionImage,
    keywords: ["emotion", "image", "감정", "표정"],
    target: { kind: "menu", menuIndex: 2, subTab: 2 },
    location: () => language.otherBots,
  },
  {
    id: "other.image",
    ...
    target: { kind: "menu", menuIndex: 2, subTab: 3 },
    location: () => language.otherBots,
  },
  {
    id: "page.display",
    label: () => language.display,
    keywords: ["display", "theme", "appearance", "화면", "테마"],
    target: { kind: "menu", menuIndex: 3 },
  },
  {
    id: "page.plugin",
    label: () => language.plugin,
    keywords: ["plugin", "플러그인"],
    target: { kind: "menu", menuIndex: 4 },
  },
  {
    id: "page.advanced",
    label: () => language.advancedSettings,
    keywords: ["advanced", "developer", "고급", "개발자"],
    target: { kind: "menu", menuIndex: 6 },
  },
];
manualEntries.push(
  {
    ...
    target: { kind: "menu", menuIndex: 8 },
  },
  {
    id: "page.regex",
    label: () => language.regexScript,
    keywords: ["regex", "regexp", "정규식", "정규표현식"],
    target: { kind: "menu", menuIndex: 9 },
  },
  {
    id: "page.language",
    label: () => language.language,
    keywords: ["language", "translator", "translation", "언어", "번역"],
    target: { kind: "menu", menuIndex: 10 },
  },
  {
    id: "page.accessibility",
    label: () => language.accessibility,
    keywords: ["accessibility", "convenience", "접근성", "편의"],
    target: { kind: "menu", menuIndex: 11 },
  },
  {
    id: "page.persona",
    label: () => language.persona,
    keywords: ["persona", "user", "profile", "페르소나", "사용자"],
    target: { kind: "menu", menuIndex: 12 },
  },
  {
    id: "page.promptTemplate",
    label: () => language.promptTemplate,
    keywords: ["prompt template", "프롬프트 템플릿"],
    target: { kind: "menu", menuIndex: 13 },
  },
  {
    id: "page.module",
    label: () => language.modules,
    keywords: ["module", "lua", "script", "모듈", "스크립트"],
    target: { kind: "menu", menuIndex: 14 },
  },
  {
    id: "page.hotkey",
    label: () => language.hotkey,
    keywords: ["hotkey", "shortcut", "keyboard", "핫키", "단축키"],
  ...
  },
  {
    ...
    target: { kind: "dbExplorer" },
  },
  {
    id: "page.storageExplorer",
    label: () => language.storageExplorer,
    keywords: ["storage", "assets", "orphan", "missing", "저장소", "에셋"],
    target: { kind: "storageExplorer" },
  },
);
...
export function searchSettings(rawQuery: string): SettingSearchResult[] {
  ...
  for (const source of sources) {
    ...
    for (const item of flattenVisible(source.items, ctx)) {
      ...
      const rank = rankMatch(
        query,
        [label, englishLabel(item)],
        item.keywords ?? [],
        [help, englishHelp(item)],
      );
      if (rank < 0) continue;
      results.push({
        key: `${source.menuIndex}:${source.subTab ?? ""}:${item.id}`,
        label,
        location: [source.pageLabel(), source.tabLabel?.()]
          .filter(Boolean)
          .join(" · "),
        help: help || undefined,
        target: {
  ...
  for (const entry of manualEntries) {
    if (
      isTauri &&
      (entry.target.kind === "dbExplorer" ||
        entry.target.kind === "storageExplorer")
    )
      continue;
    if (
      entry.target.kind === "menu" &&
      !isMenuAvailable(entry.target.menuIndex)
    )
      continue;
