...
export const accessibilitySettingsItems: SettingItem[] = [
  ...
  },
  {
    ...
    condition: (ctx) =>
      ctx.db.autoScrollToNewMessage && !ctx.db.alwaysScrollToNewMessage,
    options: {
      selectOptions: [
        {
          value: "bottom-center",
          label: language.newMessageButtonBottomCenter,
        },
        { value: "bottom-right", label: language.newMessageButtonBottomRight },
        { value: "bottom-left", label: language.newMessageButtonBottomLeft },
        {
          value: "floating-circle",
          label: language.newMessageButtonFloatingCircle,
        },
  ...
  {
    type: "custom",
    id: "acc.customSidebarConfig",
    componentId: "CustomSidebarConfig",
  },
];
