...
export async function convertViaCanvas(blob: Blob, mimeType: string, quality = 0.95): Promise<Blob> {
    const canvas = await loadImageBlobToCanvas(blob, { alpha: !mimeType.includes('jpeg') })
