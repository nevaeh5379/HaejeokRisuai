...
export const THEMES: Record<ThemeKey, ThemeInfo> = {
  basic: {
    name: "기본",
    description:
      "가장 일반적인 말풍선 디자인입니다. 색상 팔레트를 자유롭게 변경할 수 있습니다.",
  },
  custom: {
    name: "커스텀 (CSS)",
  ...
  smart: {
    name: "스마트",
    description:
      "세련된 글래스모피즘 효과와 부드러운 곡선을 가진 현대적인 디자인입니다.",
    color: {
      background: "#1a1d24",
  ...
  simple: {
    name: "심플",
    description:
      "이미지와 장식을 최소화하여 텍스트에 집중할 수 있는 간결한 디자인입니다.",
    color: {
      background: "#fafafa",
      cardBg: "transparent",
...
// ─── UI Option Descriptors ───────────────────────────────────────────────────

export const HEADER_LAYOUT_OPTIONS: readonly OptionDescriptor<HeaderLayout>[] =
  [
    {
      value: "default",
      label: "기본",
      description: "표준 상단 프로필 및 태그 레이아웃입니다.",
    },
    {
      value: "compact",
      label: "컴팩트",
      description: "간결하게 한 줄로 요약된 컴팩트 레이아웃입니다.",
    },
    {
      value: "banner",
      label: "배너",
      description: "상단 와이드 배너 이미지가 포함된 레이아웃입니다.",
    },
    {
      value: "smart",
      label: "스마트",
      description: "세련된 글래스모피즘 스타일의 스마트 레이아웃입니다.",
    },
    {
      value: "cover",
      label: "커버",
      description: "캐릭터 카드를 전면에 배치하는 커버 레이아웃입니다.",
    },
  ] as const;
  ...
  [
    {
      value: "basic",
      label: "기본",
      description: "대화 말풍선 형태의 기본 프리뷰 및 이미지 내보내기",
    },
    {
      value: "html",
      label: "HTML",
      description: "스타일과 인터랙션이 포함된 단일 독립형 HTML 파일",
    },
    {
      value: "markdown",
      label: "마크다운",
      description: "대화 서식이 적용된 마크다운 텍스트 문서",
    },
    {
      value: "text",
      label: "텍스트",
      description: "텍스트 전용 일반 로그 파일",
    },
  ] as const;
...
export const IMAGE_RESOLUTION_OPTIONS: readonly OptionDescriptor<string>[] = [
...
/** Resolves the effective palette for the current theme/color selection. */
