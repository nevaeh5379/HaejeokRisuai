...
export type ThemeKey =
  "basic" | "custom" | "modern" | "smart" | "simple" | "log" | "raw";
...
export type AvatarPosition =
  "left" | "right" | "opposite" | "top-left" | "top-right" | "opposite-top";
export type AvatarShape =
  "theme" | "circle" | "square" | "rounded" | "squircle";
...
export interface LogExporterSettings
  extends LogExportProgressCallbacks, MessageDisplayOptions {
  // --- Format & Theming ---
  format: ExportFormat;
  theme: ThemeKey;
  color: ColorKey;
