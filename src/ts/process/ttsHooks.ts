...
export function registerTTSPreprocessor(
  fn: TTSHookFn<BeforeTTSContext, BeforeTTSResult>,
): void {
  preprocessors.push(fn);
}

export function unregisterTTSPreprocessor(
  fn: TTSHookFn<BeforeTTSContext, BeforeTTSResult>,
): void {
...
export function registerTTSPostprocessor(
  fn: TTSHookFn<AfterTTSContext, AfterTTSResult>,
): void {
  postprocessors.push(fn);
}

export function unregisterTTSPostprocessor(
  fn: TTSHookFn<AfterTTSContext, AfterTTSResult>,
): void {
...
export function getTTSPreprocessors(): ReadonlyArray<
  TTSHookFn<BeforeTTSContext, BeforeTTSResult>
> {
...
export function getTTSPostprocessors(): ReadonlyArray<
  TTSHookFn<AfterTTSContext, AfterTTSResult>
> {
