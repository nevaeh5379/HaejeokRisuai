...
<div class="relative w-full h-full min-h-screen bg-bgcolor text-textcolor flex flex-col items-center justify-center p-3 md:p-6 overflow-y-auto selection:bg-blue-600 selection:text-white">
  ...
  {#if showStorageForm}
    ...
    >
      ...
      <div
        class="bg-darkbg border border-borderc/20 rounded-2xl p-5 md:p-6 w-full max-w-md shadow-2xl flex flex-col gap-4 relative z-10"
        in:scale={{ duration: 180, start: 0.96 }}
      >
        <!-- Modal Header -->
        <div class="flex items-center justify-between border-b border-borderc/15 pb-3">
