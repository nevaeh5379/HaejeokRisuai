...
<div class="w-full flex flex-col gap-3">
  ...
  <div class="flex flex-col gap-2.5 pb-2.5 border-b border-darkborderc/60">
    ...
    <div class="flex flex-col gap-2 text-xs">
      <!-- Horizontal Scrollable Category & Tag Chips -->
      <div class="flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar flex-nowrap shrink-0">
        <button 
        ...
        <div class="h-4 w-px bg-darkborderc/60 mx-0.5 shrink-0"></div>
      ...
      <div class="text-xs text-textcolor2 flex items-center justify-between shrink-0 px-0.5">
