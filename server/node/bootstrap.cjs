...
const backupCoreOutputs = [
  ...
  path.join(backupCoreRoot, "dist/exportPlan.js"),
  ...
  path.join(backupCoreRoot, "dist/node/exportEntries.js"),
  path.join(backupCoreRoot, "dist/node/exportArchive.js"),
  path.join(backupCoreRoot, "dist/node/exportService.js"),
  path.join(backupCoreRoot, "dist/node/exportStream.js"),
...
const backupCoreSources = [
  ...
  path.join(backupCoreRoot, "src/exportPlan.ts"),
  ...
  path.join(backupCoreRoot, "src/node/exportEntries.ts"),
  path.join(backupCoreRoot, "src/node/exportArchive.ts"),
  path.join(backupCoreRoot, "src/node/exportService.ts"),
  path.join(backupCoreRoot, "src/node/exportStream.ts"),
